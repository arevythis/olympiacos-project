(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__5423c6._.js", {
...
const TeamsTable = ()=>{
    ...
    const fetchTeams = ()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get('/api/teams').then((response)=>setTeams(response.data)).catch((error)=>console.error('Error fetching teams:', error));
    };
    const deleteTeam = async (teamId)=>{
        ...
        if (confirmation) {
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].delete('/api/teams/delete', {
                    data: {
                        id: teamId
                    }
                });
...
_s(TeamsTable, "hU3Sw1Tnedh0NS+xkdAiP64GDBg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__5423c6._.js.map