(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__e5f33f._.js", {
...
_s(Navbar, "irPLFJ3DqMTL8RNRVsehGT4mySY=", false, function() {
    return [
...
const Teams = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Teams.useEffect": ()=>{
            ...
            fetch(`/api/matches/${matchId}`).then({
                "Teams.useEffect": (response)=>response.json()
            }["Teams.useEffect"]).then({
                "Teams.useEffect": (data)=>{
                    setMatch(data);
                }
            }["Teams.useEffect"]).catch({
                "Teams.useEffect": (error)=>console.error('Error loading match details:', error)
            }["Teams.useEffect"]);
        }
    }["Teams.useEffect"], []);
    const checkLoginStatus = ()=>{
...
_s(Teams, "UinkFRRFaLEQrr4dKDfD951MIzo=");
_c = Teams;
const __TURBOPACK__default__export__ = Teams;
var _c;
__turbopack_refresh__.register(_c, "Teams");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__e5f33f._.js.map